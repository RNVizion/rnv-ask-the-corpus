...
_2026-09-14T08:04:20+00:00 · commit `ca3795a`_
...
> **Index and manifest differ.** Declared but not indexed: ['honest-and-wrong']. Indexed but not declared: —. Scores below describe the index, which is what the bot answers from.
